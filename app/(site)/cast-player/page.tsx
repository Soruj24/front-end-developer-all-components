    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
          Media player with Chromecast device discovery, playback controls, and cast connection
          management.
        </p>
      </header>
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Video Player</h3>
          <p className="text-sm text-muted-foreground">
            Full video player with progress, volume, speed, and cast controls.
          </p>
          <ComponentPreview id="cast-video">
            <VideoPlayerDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Device Picker</h3>
          <p className="text-sm text-muted-foreground">
            Chromecast device discovery with signal strength and connection status.
          </p>
          <ComponentPreview id="cast-picker">
            <CastDevicePickerDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Seekable Progress</h3>
          <p className="text-sm text-muted-foreground">
            Interactive progress bar with scrubbing handle and time display.
          </p>
          <ComponentPreview id="cast-progress">
            <ProgressBarDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Audio Player</h3>
          <p className="text-sm text-muted-foreground">
            Audio-specific player with album art, track info, and playback controls.
          </p>
          <ComponentPreview id="cast-audio">
            <AudioPlayerDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Cast Connected</h3>
          <p className="text-sm text-muted-foreground">
            Active cast session with device info, volume control, and disconnect.
          </p>
          <ComponentPreview id="cast-connected">
            <CastDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Playlist Queue</h3>
          <p className="text-sm text-muted-foreground">
            Track queue with current playing indicator and inline playback controls.
          </p>
          <ComponentPreview id="cast-playlist">
            <PlaylistDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Mini Player</h3>
          <p className="text-sm text-muted-foreground">
            Compact floating player with video preview and basic controls.
          </p>
          <ComponentPreview id="cast-mini">
            <MiniPlayerDemo />
          </ComponentPreview>
        </div>
      </section>
        ...
        <div className="overflow-hidden rounded-lg border">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">poster</td>
                <td className="px-4 py-3 text-muted-foreground">string</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">No</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">onCast</td>
                <td className="px-4 py-3 text-muted-foreground">{"(device: CastDevice) => void"}</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">No</td>
              </tr>
              <tr className="border-b">
