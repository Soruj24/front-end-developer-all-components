...
const installCommand = `npx component-library@latest add forms`;

const usageCode = `import { Field, FieldLabel, FieldError } from "@/components/_field";
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">Basic Validation</td>
                <td className="px-4 py-3 text-muted-foreground">Form with required fields and error states</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">Input Variants</td>
                <td className="px-4 py-3 text-muted-foreground">Text inputs, types, and sizes</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">Textarea</td>
                <td className="px-4 py-3 text-muted-foreground">Multi-line text input patterns</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">Select &amp; Choice</td>
                <td className="px-4 py-3 text-muted-foreground">Dropdowns, radio buttons, and checkboxes</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">Toggle Switches</td>
                <td className="px-4 py-3 text-muted-foreground">Boolean toggle controls</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">File Upload</td>
                <td className="px-4 py-3 text-muted-foreground">Drag and drop file upload zone</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">Multi-Step</td>
                <td className="px-4 py-3 text-muted-foreground">Wizard-style multi-step form flow</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-xs">Payment</td>
                <td className="px-4 py-3 text-muted-foreground">Credit card payment form</td>
              </tr>
            </tbody>
          </table>
        </div>
