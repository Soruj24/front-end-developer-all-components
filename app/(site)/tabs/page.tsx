      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="overflow-x-auto rounded-xl border border-border">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">activeTab</td>
              ...
              <tr className="border-b border-border">
                ...
                <td className="px-4 py-3 text-muted-foreground">&quot;underline&quot; | &quot;pills&quot; | &quot;capsule&quot;</td>
        ...
        <div className="overflow-x-auto rounded-xl border border-border">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/50">
                <th className="px-4 py-3 text-left font-medium text-foreground">Tab Property</th>
                <th className="px-4 py-3 text-left font-medium text-foreground">Type</th>
            ...
            <tbody>
              <tr className="border-b border-border">
                ...
                <td className="px-4 py-3 text-muted-foreground">string</td>
                <td className="px-4 py-3 text-muted-foreground">Unique identifier for the tab</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">label</td>
                <td className="px-4 py-3 text-muted-foreground">string</td>
                <td className="px-4 py-3 text-muted-foreground">Display text for the tab</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">content</td>
                <td className="px-4 py-3 text-muted-foreground">ReactNode</td>
                <td className="px-4 py-3 text-muted-foreground">Content shown when the tab is active</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">icon</td>
                <td className="px-4 py-3 text-muted-foreground">ReactNode</td>
                <td className="px-4 py-3 text-muted-foreground">Optional icon displayed before the label</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">badge</td>
                <td className="px-4 py-3 text-muted-foreground">string | number</td>
                <td className="px-4 py-3 text-muted-foreground">Optional badge displayed after the label</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-mono text-xs text-foreground">disabled</td>
                <td className="px-4 py-3 text-muted-foreground">boolean</td>
                <td className="px-4 py-3 text-muted-foreground">Disables the tab, preventing selection</td>
              </tr>
            </tbody>
          </table>
        </div>
