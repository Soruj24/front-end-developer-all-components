...
const installCommand = "npx component-library@latest add icon-picker";

const usageCode = `import { IconPicker } from "@/components/ui";
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
          Searchable icon picker grid with categories, search filtering, preview on hover, and clipboard copy for icon selection.
        </p>
      </header>
