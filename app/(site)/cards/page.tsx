        ...
        <div className="grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              A simple card with title and description. Perfect for minimal
              layouts.
            </p>
          </div>
          ...
          <div className="overflow-hidden rounded-lg border border-border">
            <div className="p-4">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Image placed at the bottom for variety.
              </p>
            </div>
            <div className="flex h-32 items-center justify-center bg-gradient-to-br from-amber-100 to-orange-200 text-4xl dark:from-amber-900 dark:to-orange-900">
              ⬇️
            </div>
          </div>
        </div>
        ...
        <div className="grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
            <div className="flex items-start justify-between">
              ...
              <span className="rounded-full bg-primary-soft px-2.5 py-0.5 text-xs font-medium text-primary dark:bg-blue-900/40 dark:text-blue-300">
                New
              </span>
            </div>
            <h2 className="mt-3 font-semibold">Badge Card</h2>
            <p className="mt-1 text-sm text-muted-foreground">
              Highlight status or category with a colorful badge.
            </p>
          </div>
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
            <div className="flex items-center gap-3">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              User card with avatar, name, and role.
            </p>
          </div>
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
            <span className="text-3xl">📊</span>
        ...
        <div className="grid w-full gap-6 sm:grid-cols-2">
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
            ...
            <div className="mt-4 flex gap-2">
              <button className="rounded-md bg-zinc-900 px-4 py-1.5 text-sm text-white hover:bg-muted dark:bg-foreground dark:text-background">
                Save
              </button>
              <button className="rounded-md border px-4 py-1.5 text-sm hover:bg-muted dark:border-border">
                Cancel
              </button>
            </div>
          </div>
          <div className="flex overflow-hidden rounded-lg border border-border">
            <div className="flex w-32 shrink-0 items-center justify-center bg-gradient-to-br from-emerald-100 to-teal-200 text-4xl dark:from-emerald-900 dark:to-teal-900">
              ➡️
            </div>
          ...
          <div className="flex overflow-hidden rounded-lg border border-border">
            ...
            <div className="flex w-32 shrink-0 items-center justify-center bg-gradient-to-br from-rose-100 to-pink-200 text-4xl dark:from-rose-900 dark:to-pink-900">
              ⬅️
            </div>
          </div>
        </div>
      ...
      <ComponentPreview id="card-overlay-gradient">
        <div className="grid w-full gap-6 sm:grid-cols-2">
          <div className="group relative flex h-56 cursor-pointer items-end overflow-hidden rounded-lg bg-gradient-to-br from-zinc-800 to-zinc-900">
            ...
            <div className="relative z-10 p-5 text-white">
              ...
              <p className="mt-1 text-sm text-white/80">
                Text overlaid on a dark gradient background.
              </p>
              <button className="mt-2 rounded-md bg-white/20 px-3 py-1 text-xs backdrop-blur hover:bg-white/30">
                Explore
              </button>
            </div>
          </div>
          <div className="flex h-56 flex-col justify-end rounded-lg bg-gradient-to-br from-blue-600 to-purple-700 p-5 text-white">
            ...
            <p className="mt-1 text-sm text-white/80">
              Vibrant gradient with white text for impact.
            </p>
          </div>
        </div>
      </ComponentPreview>
      ...
      <ComponentPreview id="card-elevated-flat-footer">
        <div className="grid w-full gap-6 sm:grid-cols-3">
          ...
          <div className="rounded-lg p-5">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Borderless, shadowless minimal card.
            </p>
          </div>
          <div className="rounded-lg border border-border">
            <div className="border-b border-black/[.08] px-4 py-3 font-semibold dark:border-white/[.145]">
              Header
            </div>
            <div className="p-4 text-sm text-muted-foreground">
              Card body content goes here in the middle.
            </div>
            <div className="border-t border-black/[.08] px-4 py-3 text-xs text-muted-foreground/70 dark:border-white/[.145]">
              Footer
            </div>
          </div>
        </div>
          ...
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
            ...
            <div className="mt-3 space-y-3">
              {notifications.map((n, i) => (
                <div
                  key={i}
                  className="flex items-start gap-3 border-b border-black/[.04] pb-3 last:border-0 last:pb-0 dark:border-white/[.06]"
                >
                  <span>{n.icon}</span>
        ...
        <div className="w-full max-w-md rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
          ...
          <div className="mt-3 flex flex-col gap-3">
            ...
            <input
              ...
              className="rounded-md border border-border px-3 py-2 text-sm outline-none focus:border-zinc-500 dark:border-border dark:bg-transparent"
            />
            <button className="rounded-md bg-zinc-900 py-2 text-sm text-white hover:bg-muted dark:bg-foreground dark:text-background">
              Submit
            </button>
          </div>
        </div>
      ...
      <ComponentPreview id="card-rating-tags-product">
        <div className="grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145]">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Content card with technology tags.
            </p>
            <div className="mt-3 flex flex-wrap gap-1.5">
              {["React", "TypeScript", "Tailwind", "Next.js"].map((t) => (
                <span
                  key={t}
                  className="rounded-md bg-muted px-2 py-0.5 text-xs font-medium dark:bg-muted"
                >
                  {t}
                </span>
              ))}
          ...
          <div className="overflow-hidden rounded-lg border border-border">
            <div className="flex h-40 items-center justify-center bg-gradient-to-br from-zinc-100 to-zinc-200 text-5xl dark:from-zinc-800 dark:to-zinc-700">
              🛍️
            </div>
            <div className="p-4">
      ...
      <ComponentPreview id="card-blog-profile">
        <div className="grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {posts.map((post, i) => (
            <div
              key={i}
              className="overflow-hidden rounded-lg border border-black/[.08] transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/[.145]"
            >
              <div className="flex h-36 items-center justify-center bg-gradient-to-br from-zinc-100 to-zinc-200 text-4xl dark:from-zinc-800 dark:to-zinc-700">
                📰
              </div>
              <div className="p-4">
                <span className="rounded-full bg-primary-soft px-2 py-0.5 text-xs font-medium text-primary dark:bg-blue-900/40 dark:text-blue-300">
                  {post.tag}
                </span>
      ...
      <ComponentPreview id="card-team-testimonial">
        <div className="grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {team.map((member, i) => (
            <div
              key={i}
              className="rounded-lg border border-black/[.08] p-5 text-center dark:border-white/[.145]"
            >
          ...
          <div className="rounded-lg border border-black/[.08] p-5 dark:border-white/[.145] sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-2 text-sm italic text-muted-foreground">
              &quot;This platform transformed how our team ships products.&quot;
            </p>
        ...
        <div className="grid w-full gap-6 sm:grid-cols-3">
          {events.map((event, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <div
                  className={`mb-1 h-2 w-2 rounded-full ${event.type === "meeting" ? "bg-blue-500" : event.type === "deadline" ? "bg-danger" : "bg-success"}`}
                />
      ...
      <ComponentPreview id="card-product-grid">
        <div className="grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {products.map((p, i) => (
            <div
              key={i}
              className="rounded-lg border border-black/[.08] p-4 transition hover:-translate-y-0.5 hover:shadow-md dark:border-white/[.145]"
            >
              <div className="flex h-32 items-center justify-center rounded-md bg-gradient-to-br from-zinc-100 to-zinc-200 text-4xl dark:from-zinc-800 dark:to-zinc-700">
                📦
              </div>
              <span className="mt-2 inline-block rounded-full bg-muted px-2 py-0.5 text-xs font-medium dark:bg-muted">
                {p.tag}
              </span>
              ...
              <div className="flex items-center gap-1 text-xs text-muted-foreground/70">
                {[1, 2, 3, 4, 5].map((s) => (
                  <svg
                    key={s}
                    className={`h-3 w-3 ${s <= Math.floor(p.rating) ? "text-warning" : "text-zinc-200 dark:text-muted-foreground"}`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
