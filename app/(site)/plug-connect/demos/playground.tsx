...
import { ConnectedVariant, ListVariant, ActionVariant, GridVariant, StatusVariant } from "./playground-variants";

const VARIANTS = ["connected", "list", "action", "grid", "status"] as const;
type Variant = (typeof VARIANTS)[number];

export function PlaygroundDemo() {
  const [variant, setVariant] = useState<Variant>("connected");
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4">
        {variant === "connected" && <ConnectedVariant />}
