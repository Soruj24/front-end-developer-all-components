...
const usageCode = `import { Spinner } from "@/components/loading";
...
const loadingProps = [
  { prop: "variant", type: "\"spinner\" | \"progress\" | \"skeleton\" | \"overlay\"", default: "\"spinner\"", required: "No" },
  { prop: "size", type: "\"sm\" | \"md\" | \"lg\"", default: "\"md\"", required: "No" },
  { prop: "value", type: "number", default: "-", required: "No" },
  { prop: "label", type: "string", default: "-", required: "No" },
  { prop: "fullScreen", type: "boolean", default: "false", required: "No" },
];
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      ...
      <section className="flex flex-col gap-6">
        ...
        <h3 className="text-lg font-medium text-foreground">Spinner Variants</h3>
        <p className="text-sm text-muted-foreground">Different spinner styles and sizes.</p>
        ...
        <h3 className="text-lg font-medium text-foreground">Progress Bars</h3>
        <p className="text-sm text-muted-foreground">Determinate, indeterminate, and colored progress bars.</p>
        ...
        <h3 className="text-lg font-medium text-foreground">Skeleton Screens</h3>
        <p className="text-sm text-muted-foreground">Content placeholders for async loading states.</p>
        ...
        <h3 className="text-lg font-medium text-foreground">Overlays & Animations</h3>
        <p className="text-sm text-muted-foreground">Full-screen overlays, inline loading, and animated effects.</p>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="overflow-hidden rounded-lg border">
          <table className="w-full text-sm">
            ...
            <tbody>
              {loadingProps.map((row, i) => (
                <tr key={row.prop} className={i < loadingProps.length - 1 ? "border-b" : ""}>
