...
const installCommand = `npx component-library@latest add drawer-panel`;
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        <div className="flex items-center gap-3">
          <h1 className="text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">Drawer Panel</h1>
          <Badge variant="primary">Layout</Badge>
        </div>
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">A sliding drawer panel component for side navigation, detail views, and modal-like overlays with smooth transitions.</p>
      </header>
      ...
      <section className="flex flex-col gap-4">
        <div><h2 className="text-xl font-semibold tracking-tight text-foreground">Right Drawer</h2><p className="mt-1 text-sm text-muted-foreground">A drawer that slides in from the right side.</p></div>
        <ComponentPreview id="drawer-panel-right">
      ...
      <section className="flex flex-col gap-4">
        <div><h2 className="text-xl font-semibold tracking-tight text-foreground">Left Drawer</h2><p className="mt-1 text-sm text-muted-foreground">A navigation drawer from the left side.</p></div>
        <ComponentPreview id="drawer-panel-left">
          <div className="w-full p-4">
            <div className="relative h-64 bg-muted/30 rounded-lg overflow-hidden">
      ...
      <section className="flex flex-col gap-4">
        <div><h2 className="text-xl font-semibold tracking-tight text-foreground">Bottom Drawer</h2><p className="mt-1 text-sm text-muted-foreground">A drawer that slides up from the bottom.</p></div>
        <ComponentPreview id="drawer-panel-bottom">
          <div className="w-full p-4">
            <div className="relative h-64 bg-muted/30 rounded-lg overflow-hidden">
