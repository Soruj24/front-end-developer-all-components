...
import { Lock, Mail, User, Eye, EyeOff, LogIn, Shield } from "lucide-react";

const installCommand = `npx component-library@latest add login-card`;
const usageCode = `import { LoginCard } from "@/components/ui/login-card";
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input className="w-full pl-9 pr-3 py-2 rounded-lg border bg-background text-sm outline-none focus:ring-2 focus:ring-ring" placeholder="you@example.com" />
            </div>
          </div>
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input className="w-full pl-9 pr-10 py-2 rounded-lg border bg-background text-sm outline-none focus:ring-2 focus:ring-ring" type={showPassword ? "text" : "password"} placeholder="Enter your password" />
    ...
    <div className="w-full max-w-sm mx-auto">
      <div className="rounded-xl border bg-background p-6 shadow-sm">
        <div className="text-center mb-6">
          ...
          <h2 className="text-lg font-semibold text-foreground">Magic Link</h2>
        ...
        {sent ? (
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-foreground">Email</label>
              <input className="px-3 py-2 rounded-lg border bg-background text-sm outline-none focus:ring-2 focus:ring-ring" placeholder="you@example.com" />
            </div>
    ...
    <div className="w-full max-w-sm mx-auto">
      <div className="rounded-xl border bg-background p-6 shadow-sm">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-medium text-foreground">Password</label>
            <input className="px-3 py-2 rounded-lg border bg-background text-sm outline-none focus:ring-2 focus:ring-ring" type="password" placeholder="Enter your password" />
          </div>
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input className="w-full pl-9 pr-3 py-2 rounded-lg border bg-background text-sm outline-none focus:ring-2 focus:ring-ring" placeholder="John Doe" />
            </div>
          </div>
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-medium text-foreground">Email</label>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
              <input className="w-full pl-9 pr-10 py-2 rounded-lg border bg-background text-sm outline-none focus:ring-2 focus:ring-ring" type={showPassword ? "text" : "password"} placeholder="Create a password" />
              <button onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground">
                {showPassword ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
              </button>
            </div>
...
export default function LoginCardPage() {
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      ...
      <section className="flex flex-col gap-4">
        <div><h2 className="text-xl font-semibold tracking-tight text-foreground">Examples</h2><p className="mt-1 text-sm text-muted-foreground">Different login card configurations.</p></div>
        <ComponentPreview id="login-card-form"><div className="w-full p-4"><div className="flex items-center justify-center py-8"><LoginForm /></div></div></ComponentPreview>
        <ComponentPreview id="login-card-social"><div className="w-full p-4"><div className="flex items-center justify-center py-8"><SocialLogin /></div></div></ComponentPreview>
        <ComponentPreview id="login-card-magic"><div className="w-full p-4"><div className="flex items-center justify-center py-8"><MagicLink /></div></div></ComponentPreview>
        <ComponentPreview id="login-card-2fa"><div className="w-full p-4"><div className="flex items-center justify-center py-8"><TwoFactor /></div></div></ComponentPreview>
        <ComponentPreview id="login-card-remember"><div className="w-full p-4"><div className="flex items-center justify-center py-8"><RememberMe /></div></div></ComponentPreview>
        <ComponentPreview id="login-card-forgot"><div className="w-full p-4"><div className="flex items-center justify-center py-8"><ForgotPassword /></div></div></ComponentPreview>
        <ComponentPreview id="login-card-signup"><div className="w-full p-4"><div className="flex items-center justify-center py-8"><SignupForm /></div></div></ComponentPreview>
      </section>
      <section className="flex flex-col gap-4">
