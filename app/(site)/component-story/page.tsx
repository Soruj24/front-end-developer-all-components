    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
          Component story viewer with variant switching, interactive controls, and lifecycle
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Variant Switching</h3>
          <p className="text-sm text-muted-foreground">
            Switch between component variants with live preview and props display.
          </p>
          <ComponentPreview id="story-variants">
            <VariantSwitchingDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Interactive Controls</h3>
          <p className="text-sm text-muted-foreground">
            Toggle props with switches and dropdowns to see live changes.
          </p>
          <ComponentPreview id="story-controls">
            <InteractiveControlsDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Lifecycle Timeline</h3>
          <p className="text-sm text-muted-foreground">
            Step through component lifecycle phases with timing info.
          </p>
          <ComponentPreview id="story-lifecycle">
            <LifecycleTimelineDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Theme Preview</h3>
          <p className="text-sm text-muted-foreground">
            Preview components across light, dark, and system themes.
          </p>
          <ComponentPreview id="story-theme">
            <ThemePreviewDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Props Documentation</h3>
          <p className="text-sm text-muted-foreground">
            Expandable props table with types, defaults, and descriptions.
          </p>
          <ComponentPreview id="story-props">
            <PropsTableDemo />
          </ComponentPreview>
        </div>

        <div className="flex flex-col gap-3">
          <h3 className="text-lg font-medium text-foreground">Component Grid</h3>
          <p className="text-sm text-muted-foreground">
            Grid view of all variants and sizes at a glance.
          </p>
          <ComponentPreview id="story-grid">
            <ComponentGridDemo />
          </ComponentPreview>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            Toggle between preview and source code for each variant.
          </p>
          <ComponentPreview id="story-code">
            <CodePreviewDemo />
          </ComponentPreview>
        </div>
      </section>
        ...
        <div className="overflow-hidden rounded-lg border">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">variants</td>
                <td className="px-4 py-3 text-muted-foreground">string[]</td>
                <td className="px-4 py-3 text-muted-foreground">[]</td>
              ...
              <tr className="border-b">
                ...
                <td className="px-4 py-3 text-muted-foreground">{"(variant: string) => ReactNode"}</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">No</td>
              </tr>
              <tr>
