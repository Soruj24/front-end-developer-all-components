          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="px-4 py-3 text-muted-foreground">PropsSchema</td>
              ...
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">preview</td>
                <td className="px-4 py-3 text-muted-foreground">(values: Record&lt;string, unknown&gt;) =&gt; ReactNode</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">Yes</td>
              </tr>
              <tr>
