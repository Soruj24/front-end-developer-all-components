        ...
        <div className="overflow-x-auto rounded-xl border border-border">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">showMarks</td>
                <td className="px-4 py-3 text-muted-foreground">boolean</td>
                <td className="px-4 py-3 text-muted-foreground">false</td>
                <td className="px-4 py-3 text-muted-foreground">No</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">marks</td>
                <td className="px-4 py-3 text-muted-foreground">{"{ value: number; label?: string }[]"}</td>
              ...
              <tr className="border-b border-border">
                ...
                <td className="px-4 py-3 text-muted-foreground">ChangeEventHandler&lt;HTMLInputElement&gt;</td>
                <td className="px-4 py-3 text-muted-foreground">—</td>
                <td className="px-4 py-3 text-muted-foreground">No</td>
              </tr>
              <tr>
