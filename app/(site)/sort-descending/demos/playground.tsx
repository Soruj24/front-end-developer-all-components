...
import { ListVariant, DropdownVariant, TableVariant, GridVariant, LeaderboardVariant, TopVariant, HighScoreVariant } from "./playground-variants";

const VARIANTS = ["list", "dropdown", "table", "grid", "leaderboard", "top", "highscore"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4 flex justify-center">
        ...
        {variant === "leaderboard" && <LeaderboardVariant />}
        {variant === "top" && <TopVariant />}
        {variant === "highscore" && <HighScoreVariant />}
      </div>
    </div>
  );
}
