  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      ...
      <section className="flex flex-col gap-4">
        ...
        <ComponentPreview code={`<HeaterControl value={22} />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">With Range</h2>
        <ComponentPreview code={`<HeaterControl value={22} min={16} max={30} />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Disabled</h2>
        <ComponentPreview code={`<HeaterControl value={22} disabled />`} />
      </section>
      <section className="flex flex-col gap-4">
