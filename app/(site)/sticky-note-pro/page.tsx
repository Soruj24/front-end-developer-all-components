...
const usageCode = `<StickyNotePro title="Meeting Notes" color="yellow" />`;
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">A layout component for creating sticky notes with rich text editing, color options, and drag-and-drop positioning.</p>
      </header>
      ...
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Basic Note</h2>
        <ComponentPreview component="StickyNoteProBasic" />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Color Options</h2>
        <ComponentPreview component="StickyNoteProColors" />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Draggable Note</h2>
        <ComponentPreview component="StickyNoteProDraggable" />
      </section>
      <section className="flex flex-col gap-4">
