          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b border-border">
                ...
                <td className="px-4 py-3 text-muted-foreground">MultiSelectOption[]</td>
              ...
              <tr className="border-b border-border">
                ...
                <td className="px-4 py-3 text-muted-foreground">string</td>
                <td className="px-4 py-3 text-muted-foreground">&quot;Select items...&quot;</td>
                <td className="px-4 py-3 text-muted-foreground">No</td>
              </tr>
              <tr className="border-b border-border">
              ...
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">maxDisplay</td>
