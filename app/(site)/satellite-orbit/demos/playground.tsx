...
import { BasicVariant, MultipleVariant, PathVariant, InfoVariant, ConfigurableVariant } from "./playground-variants";

const VARIANTS = ["basic", "multiple", "path", "info", "configurable"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4">
        ...
        {variant === "multiple" && <MultipleVariant />}
        {variant === "path" && <PathVariant />}
        {variant === "info" && <InfoVariant />}
        {variant === "configurable" && <ConfigurableVariant />}
      </div>
    </div>
  );
}
