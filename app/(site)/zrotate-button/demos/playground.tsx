...
import { BasicRotate, RotateDirections, RotateSpeeds, RotateIconOnly, RotateDegrees } from "./rotate-demos";

const VARIANTS = ["basic", "directions", "speeds", "icon-only", "degrees"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4 flex justify-center">
        ...
        {variant === "icon-only" && <RotateIconOnly />}
        {variant === "degrees" && <RotateDegrees />}
      </div>
    </div>
  );
}
