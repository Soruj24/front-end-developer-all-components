...
import { BasicVariant, AttachmentVariant, ChatVariant, DisabledVariant, CounterVariant } from "./playground-variants";

const VARIANTS = ["basic", "attachment", "chat", "disabled", "counter"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4">
        ...
        {variant === "attachment" && <AttachmentVariant />}
        {variant === "chat" && <ChatVariant />}
        {variant === "disabled" && <DisabledVariant />}
