...
import { ListVariant, DropdownVariant, TableVariant, GridVariant, PriorityVariant, RankedVariant, ScoreVariant } from "./playground-variants";

const VARIANTS = ["list", "dropdown", "table", "grid", "priority", "ranked", "score"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4 flex justify-center">
        ...
        {variant === "priority" && <PriorityVariant />}
        {variant === "ranked" && <RankedVariant />}
        {variant === "score" && <ScoreVariant />}
      </div>
    </div>
  );
}
