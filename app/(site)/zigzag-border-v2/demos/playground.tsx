...
import { BasicZigzag, ZigzagPositions, ZigzagColors, ZigzagSizes, ZigzagInteractive } from "./zigzag-demos";

const VARIANTS = ["basic", "positions", "colors", "sizes", "interactive"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4">
        ...
        {variant === "positions" && <ZigzagPositions />}
