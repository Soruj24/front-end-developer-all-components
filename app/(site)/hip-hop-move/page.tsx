  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      ...
      <section className="flex flex-col gap-4">
        ...
        <ComponentPreview code={`<HipHopMove />} />} />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Bounce</h2>
        <ComponentPreview code={`<HipHopMove variant="bounce" />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Spin</h2>
        <ComponentPreview code={`<HipHopMove variant="spin" />`} />
      </section>
      <section className="flex flex-col gap-4">
