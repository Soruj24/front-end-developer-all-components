...
import { BasicZigzag, ZigzagVariants, ZigzagAmplitudes, ZigzagColors, ZigzagInteractive } from "./zigzag-demos";

const VARIANTS = ["basic", "variants", "amplitudes", "colors", "interactive"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4">
        ...
        {variant === "variants" && <ZigzagVariants />}
        {variant === "amplitudes" && <ZigzagAmplitudes />}
        {variant === "colors" && <ZigzagColors />}
        {variant === "interactive" && <ZigzagInteractive />}
      </div>
    </div>
  );
}
