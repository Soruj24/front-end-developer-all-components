...
import { BasicVariant, ResultsVariant, InteractiveVariant, FlagVariant, HighlightVariant } from "./playground-variants";

const VARIANTS = ["basic", "results", "interactive", "flags", "highlight"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4">
        ...
        {variant === "results" && <ResultsVariant />}
        {variant === "interactive" && <InteractiveVariant />}
        {variant === "flags" && <FlagVariant />}
        {variant === "highlight" && <HighlightVariant />}
      </div>
    </div>
  );
}
