...
import { BasicVariant, TargetsVariant, GridVariant, AnimatedVariant, ListVariant } from "./playground-variants";

const VARIANTS = ["basic", "targets", "grid", "animated", "list"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4 flex justify-center">
        ...
        {variant === "targets" && <TargetsVariant />}
        {variant === "grid" && <GridVariant />}
        {variant === "animated" && <AnimatedVariant />}
