...
export function CompassRoseDemo() {
...
export function HeadingIndicatorDemo() {
...
export function MiniCompassDemo() {
...
export function BearingCalculatorDemo() {
