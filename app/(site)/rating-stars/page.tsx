...
const usageCode = `import { RatingStars } from "@/components/ui";
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
          Star rating with half-star support, hover preview, read-only mode, custom icons, and accessible keyboard interaction.
        </p>
      </header>
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <ComponentPreview id="rating-stars-default">
            <div className="flex w-full items-center justify-center py-10">
              <p className="text-sm text-muted-foreground">Rating Stars demo</p>
            </div>
          </ComponentPreview>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <ComponentPreview id="rating-stars-variants">
