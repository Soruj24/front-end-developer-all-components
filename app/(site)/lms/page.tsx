          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">courses</td>
                <td className="px-4 py-3 text-muted-foreground">Course[]</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">Yes</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">lessons</td>
                <td className="px-4 py-3 text-muted-foreground">Lesson[]</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">Yes</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">instructor</td>
                <td className="px-4 py-3 text-muted-foreground">Instructor</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">Yes</td>
              </tr>
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">quizzes</td>
                <td className="px-4 py-3 text-muted-foreground">Quiz[]</td>
                <td className="px-4 py-3 text-muted-foreground">-</td>
                <td className="px-4 py-3">Yes</td>
              </tr>
              <tr>
