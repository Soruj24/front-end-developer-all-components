...
export default function LMSPage() {
  const { activeCategory, setActiveCategory, filteredCourses } =
    useCourseFilter();
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
          Learning management system with courses, curriculum, quizzes,
      ...
      <section className="flex flex-col gap-6">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Hero banner with gradient background and key learning statistics.
          </p>
              ...
              <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 py-16 sm:py-24 lg:px-8">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-4 text-lg text-white/80">
                    Learn from world-class instructors. Build real projects.
                    Advance your career.
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Filterable course grid with category filters.
          </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-muted-foreground">
            Course curriculum with lesson selection and video player.
          </p>
          <div className="rounded-lg border border-border bg-background p-6">
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <VideoPlayer
                title={
                  LESSONS[selectedLesson - 1]?.title || "No lesson selected"
                }
                duration={LESSONS[selectedLesson - 1]?.duration || "0:00"}
              />
            </div>
          </div>
        </div>
