  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">An animated music note component with floating and dancing motion effects.</p>
      </header>
      ...
      <section className="flex flex-col gap-4">
        ...
        <ComponentPreview code={`<MusicNote />} />} />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Double Note</h2>
        <ComponentPreview code={`<MusicNote variant="double" />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Floating</h2>
        <ComponentPreview code={`<MusicNote animate="float" />`} />
      </section>
      <section className="flex flex-col gap-4">
