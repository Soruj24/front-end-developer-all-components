  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      ...
      <section className="flex flex-col gap-4">
        ...
        <ComponentPreview code={`<IceCreamBowl />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Multiple Scoops</h2>
        <ComponentPreview code={`<IceCreamBowl scoops={3} />`} />
      </section>
      <section className="flex flex-col gap-4">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Custom Flavor</h2>
        <ComponentPreview code={`<IceCreamBowl flavor="strawberry" />`} />
      </section>
      <section className="flex flex-col gap-4">
