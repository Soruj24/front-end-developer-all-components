...
const usageCode = `import { AccordionMenu } from "@/components/ui";
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
          Multi-level accordion navigation menu with expand/collapse animations, keyboard navigation, and ARIA support for accessible hierarchical navigation.
        </p>
      </header>
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <ComponentPreview id="accordion-menu-default">
            <div className="flex w-full items-center justify-center py-10">
              <p className="text-sm text-subtle">Accordion Menu demo</p>
            </div>
          </ComponentPreview>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <ComponentPreview id="accordion-menu-variants">
        ...
        <div className="flex flex-col gap-3">
          ...
          <ComponentPreview id="accordion-menu-interactive">
            <div className="flex w-full items-center justify-center py-10">
