export const MIC_RECORDING_SOURCE = `"use client";
          ...
          <button
            ...
            className={\`flex h-16 w-16 items-center justify-center rounded-full transition-all \${
              recording
                ...
                : "bg-zinc-900 text-white shadow-lg shadow-zinc-900/25 hover:bg-zinc-800 active:scale-95 dark:bg-zinc-100 dark:text-zinc-900"
            }\`}
          >
