...
export function Typewriter404() {
  return (
    <NotFoundLayout className="py-20" style={{ fontFamily: "'Courier New', monospace" }}>
      ...
      <GoHomeButton className="mt-8 rounded border border-green-500 bg-transparent px-6 py-2.5 text-sm font-medium text-green-400 hover:bg-green-500/10" />
      <style>{`@keyframes blink { 50% { opacity: 0; } }`}</style>
    </NotFoundLayout>
  );
}

export function Neon404() {
  return (
    <NotFoundLayout className="py-20" style={{ background: "#0a0a0a", borderRadius: "12px" }}>
      <h1
      ...
      <p className="mt-2 text-lg" style={{ color: "#0ff", textShadow: "0 0 10px #0ff" }}>Neon sign says: Page not found</p>
      <GoHomeButton className="mt-8 rounded-full border-2 border-cyan-400 bg-transparent px-8 py-3 text-sm font-medium text-cyan-400 transition-all hover:bg-cyan-400/10 hover:shadow-lg hover:shadow-cyan-400/30" />
    </NotFoundLayout>
  );
}

export function PixelArt404() {
  return (
    <NotFoundLayout className="py-20" style={{ imageRendering: "pixelated" }}>
      ...
      <p className="mt-3 text-sm text-muted-foreground">Game Over! Page not found.</p>
      <GoHomeButton className="mt-6 rounded-lg bg-amber-500 px-6 py-2.5 text-sm font-bold text-black hover:bg-amber-400" />
    </NotFoundLayout>
  );
}

export function Origami404() {
  return (
    <NotFoundLayout className="py-20">
      ...
      <p className="mt-4 text-muted-foreground">This page folded away</p>
      <GoHomeButton className="mt-6 rounded-lg bg-zinc-700 px-6 py-2.5 text-sm font-medium text-white hover:bg-zinc-600" />
    </NotFoundLayout>
  );
}

export function PopArt404() {
  ...
  return (
    <NotFoundLayout className="py-12">
      ...
      <p className="mt-4 text-lg font-bold text-foreground">POP! Page not found</p>
      <GoHomeButton className="mt-6 rounded-full bg-foreground px-8 py-3 text-sm font-bold text-background hover:opacity-90" />
    </NotFoundLayout>
  );
}
