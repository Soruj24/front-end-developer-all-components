...
export function Chalkboard404() {
  return (
    <NotFoundLayout className="py-20" style={{ background: "#2d5016", borderRadius: "12px", minHeight: "400px", fontFamily: "'Comic Sans MS', 'Chalkboard SE', cursive" }}>
      <div className="absolute inset-0 opacity-5 pointer-events-none" style={{ backgroundImage: "url('data:image/svg+xml,%3Csvg width=\"6\" height=\"6\" viewBox=\"0 0 6 6\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"%23fff\" fillRule=\"evenodd\"%3E%3Ccircle cx=\"1\" cy=\"1\" r=\"0.5\"/%3E%3C/g%3E%3C/svg%3E')" }} />
...
export function Blueprint404() {
  return (
    <NotFoundLayout className="py-20" style={{ background: "#1a3a5c", borderRadius: "12px", minHeight: "400px", border: "3px solid #4a8cc7" }}>
...
export function Map404() {
  return (
    <NotFoundLayout className="py-20" style={{ background: "linear-gradient(135deg, #f5e6d3, #e8d5b7)", borderRadius: "12px", minHeight: "400px" }}>
      <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: "repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(139,90,43,0.1) 10px, rgba(139,90,43,0.1) 11px)" }} />
      <div className="relative z-10">
...
export function Compass404() {
  return (
    <NotFoundLayout className="py-20">
      ...
      <p className="mt-2 text-lg text-muted-foreground">Compass points to nowhere.</p>
