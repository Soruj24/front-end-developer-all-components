          ...
          <div className="flex items-center gap-6 justify-center">
            {["default", "success", "warning", "danger"].map((variant) => (
              <div key={variant} className="flex flex-col items-center gap-2">
                <span className={`relative inline-flex ${variant === "default" ? "bg-primary text-primary-foreground" : variant === "success" ? "bg-green-500 text-white" : variant === "warning" ? "bg-yellow-500 text-white" : "bg-red-500 text-white"}`} h-6 min-w-[24px] rounded-full px-1.5 flex items-center justify-center text-xs font-medium>3</span>
