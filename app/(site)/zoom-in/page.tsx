...
const installCommand = `npx component-library@latest add zoom-in`;
const usageCode = `import { ZoomIn } from "@/components/_zoom-in";
    ...
    <div className="overflow-hidden rounded-lg border border-border">
      <div className="relative flex h-64 items-center justify-center bg-foreground/5">
        <div
          ...
          style={{ width: "60%", height: "60%", transform: `scale(${zoom})` }}
        >
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-10 p-6 sm:p-10 lg:p-14">
      <header className="flex flex-col gap-3">
        <div className="flex items-center gap-3">
          <h1 className="text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">Zoom In</h1>
          <Badge variant="primary">Input</Badge>
        </div>
        <p className="max-w-2xl text-pretty text-[15px] leading-relaxed text-muted-foreground">
          Zoom controls with pinch, scroll, and button-based magnification for images and content.
        </p>
      </header>
        ...
        <div className="overflow-hidden rounded-lg border">
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b">
                <td className="px-4 py-3 font-mono text-xs">maxZoom</td>
                <td className="px-4 py-3 text-muted-foreground">number</td>
