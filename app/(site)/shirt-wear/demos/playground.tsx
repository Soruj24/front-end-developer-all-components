...
import { CardVariant, SizeVariant, ColorVariant, DetailVariant, StockVariant } from "./playground-variants";

const VARIANTS = ["card", "size", "color", "detail", "stock"] as const;
