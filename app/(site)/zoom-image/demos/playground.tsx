...
import { BasicZoom, ZoomLevels, ZoomLens, ZoomWindow, ZoomWithControls } from "./zoom-demos";

const VARIANTS = ["basic", "levels", "lens", "window", "controls"] as const;
  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="mt-4">
        ...
        {variant === "levels" && <ZoomLevels />}
        {variant === "lens" && <ZoomLens />}
        {variant === "window" && <ZoomWindow />}
        {variant === "controls" && <ZoomWithControls />}
      </div>
    </div>
  );
}
