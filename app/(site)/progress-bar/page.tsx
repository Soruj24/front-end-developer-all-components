          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b border-border">
                ...
                <td className="px-4 py-3 text-muted-foreground">&quot;default&quot; | &quot;success&quot; | &quot;warning&quot; | &quot;error&quot;</td>
              ...
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">showLabel</td>
                <td className="px-4 py-3 text-muted-foreground">boolean</td>
                <td className="px-4 py-3 text-muted-foreground">false</td>
                <td className="px-4 py-3 text-muted-foreground">No</td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-4 py-3 font-mono text-xs text-foreground">animated</td>
                <td className="px-4 py-3 text-muted-foreground">boolean</td>
